...
class SP2:
    ...
    def interp(self, t, p2):
        return SP2(staticLerp(t, self.x, p2.x), staticLerp(t, self.y, p2.y))

    def interpA(self, t, p2):
        return SP2(staticLerpA(t, self.x, p2.x), staticLerpA(t, self.y, p2.y))
...
def crossProduct(a, b):
    return SP3(a.y * b.z - a.z * b.y, a.z * b.x - a.x * b.z, a.x * b.y - a.y * b.x)
